...
DEFAULT_TRANSFORM = [
            {
                ...
                "opts": {
                    "keys": ("image_curr", "image_prev", "instance_curr", "instance_prev", "label_curr", "label_prev",
                             "center_image_curr", "center_image_prev", "flow"),
                    "degrees": 90,
                },
            },
            {
            ...
            },
            {
                ...
                "opts": {
                    "keys": ("image_curr", "image_prev", "instance_curr", "instance_prev","label_curr", "label_prev",
                             "center_image_curr", "center_image_prev", "flow"),
                    "type": (torch.FloatTensor, torch.FloatTensor, torch.ShortTensor, torch.ShortTensor,
                             torch.ShortTensor, torch.ShortTensor, torch.BoolTensor, torch.BoolTensor, torch.FloatTensor
                             ),
                },
            },
        ]
