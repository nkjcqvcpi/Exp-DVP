...
from infer.infer_ctc_data import inference
...
MODEL_PATH = os.path.join(PROJECT_PATH, "ckpts")
...
for raw_data_path in RAW_DATA_PATHS:
    for data_set in DATA_SETS:
        for data_id in ["01", "02"]:
            ...
            # time stamps
            timestamps_trained_models = [datetime.strptime(time_stamp, "%Y-%m-%d---%H-%M-%S")
